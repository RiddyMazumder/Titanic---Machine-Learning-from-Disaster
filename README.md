...
This project is built for the official Kaggle competition and follows a complete end-to-end machine learning workflow to predict passenger survival on the Titanic.
...
You can use either Jupyter Notebook or VS Code:
